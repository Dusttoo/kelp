...
const EditBusiness = () => {
  ...
  const validate = () => {
    ...
    if (name.length < 6)
      validationErrors.push("Business name must be at least 6 characters");
    if (description.length < 15)
      validationErrors.push("Description must be at least 15 characters");
    if (image.length > 255)
      validationErrors.push("Image url can not be longer than 255 characters");
    ...
    <>
      ...
      <div className="add-biz-container">
        ...
        <form onSubmit={handleSubmit} className="add-biz-form">
          ...
          <div className="bizLabel">
            <label className="biz-label">Address:</label>
            <input
              className="biz-input"
              type="text"
              value={address}
          ...
          <div className="bizLabel">
            <label className="biz-label">Image:</label>
            <input
              className="biz-input"
              type="text"
              value={image}
          ...
          <div className="bizLabel">
            <label className="biz-label">Longitude:</label>
            <input
              className="biz-input"
              type="number"
              step="0.00001"
          ...
          <div className="bizLabel">
            <label className="biz-label">Latitude:</label>
            <input
              className="biz-input"
              type="number"
              step="0.00001"
          ...
          <div className="submit-holder">
            <button className="write-review submit-button" type="submit">
              Edit your business
            </button>
          </div>
        </form>
